...
def main():
    ...
    if args.dataset_name is not None:
        ...
        raw_datasets = load_dataset(args.dataset_name, args.dataset_config_name,cache_dir='/cstor/mendeza/hf_test')
    ...
    if args.tokenizer_name:
        tokenizer = AutoTokenizer.from_pretrained('EleutherAI/gpt-neox-20b', use_fast=not args.use_slow_tokenizer,cache_dir='/cstor/mendeza/hf_test')
    elif args.model_name_or_path:
        tokenizer = AutoTokenizer.from_pretrained('EleutherAI/gpt-neox-20b', use_fast=not args.use_slow_tokenizer,cache_dir='/cstor/mendeza/hf_test')
    else:
        raise ValueError(
